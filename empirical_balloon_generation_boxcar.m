...
for testrun = 0:10
    for experiment_n = 1:10
        ...
        experiment_dir_name = 'Boxcar_Empirical_Resting-State_' + exp_name + '/run' + string(experiment_n);
        ...
        for subject_number = 1:Nsub
            ...
            disp("Subject " + subject_number  + " finished of run " + experiment_n + " of boxcar empirical structure " + exp_name )
