...
switch testrun
            case {0}
                ...
                load('../NETSIM_filters/filters/filter_60sub-1200ms-10min.mat');
            case {1}
                tr=0.25;
                nscans=nsecs/tr;
                res=1/200;           % 1/20    raw data resolution in seconds
                ...
                ntpts=nsecs/res;
                exp_name = "tr250ms";
                load('../NETSIM_filters/filters/filter_tr250ms.mat');
            case {2}
                tr=0.75;
                nscans=nsecs/tr;
                res=1/200;           % 1/20    raw data resolution in seconds
            ...
            case {3}
                ...
                ntpts=nsecs/res;
                exp_name = "tr3000ms";
                load('../NETSIM_filters/filters/filter_tr3000ms.mat');
            case {4}
                Nsub=10;
                exp_name = "10sub";
                load('../NETSIM_filters/filters/filter_10sub.mat');
            case {5}
                Nsub=30;
                exp_name = "30sub";
                load('../NETSIM_filters/filters/filter_30sub.mat');
            case {6}
                Nsub=100;
                exp_name = "100sub";
                load('../NETSIM_filters/filters/filter_100sub.mat');
            case {7}
                nsecs=300;
                nscans=nsecs/tr;
                res=1/200;           % 1/20    raw data resolution in seconds
                ...
                ntpts=nsecs/res;
                exp_name = "5min";
                load('../NETSIM_filters/filters/filter_5min.mat');
            case {8}
                nsecs=1800;
                nscans=nsecs/tr;
                res=1/200;           % 1/20    raw data resolution in seconds
                ...
                ntpts=nsecs/res;
                exp_name = "30min";
                load('../NETSIM_filters/filters/filter_30min.mat');
            case {9}
                nsecs=3600;
                nscans=nsecs/tr;
                res=1/200;           % 1/20    raw data resolution in seconds
                ...
                ntpts=nsecs/res;
                exp_name = "60min";
                load('../NETSIM_filters/filters/filter_60min.mat');
            case {10}
                tr=0.72;
                nsecs = 4500;
                nscans=nsecs/tr;
                ...
                load('../NETSIM_filters/filters/filter_excellentconditions.mat');
        ...
        experiment_dir_name = 'Cycle-Resting-State_' + exp_name + '/run' + string(experiment_n);
        ...
        for subject_number = 1:Nsub
            ...
            for m=1:length(models),
                ...
                for i=1:size(models{m}.b,1),
                    ...
                    save(strcat(datadir,'/model_art_',num2str(subject_number),'/matB_into_',roinames{i},'.txt'),'tmp','-ascii','-double');
                end;
            ...
            for i=2:N, stim_list=sprintf('%s,%d',stim_list,i); roi_list=sprintf('%s,%d',roi_list,i); end;
            ...
            disp("Subject " + subject_number  + " finished of run " + experiment_n + " of cyclic smith structure " + exp_name )
