...
metric_data_origin = r"D:\My Documents\MUIA\TFM\CasualFMRI\METRICS_STDEV_GOOD"
...
for i,structure in enumerate(structures):
    ...
    for param_exp in string_experiments:
        ...
        for algorithm in algorithms:
            ...
            data_location_txt = full_path_param + "\\stdev_results.txt"
...
cax = ax.matshow(specificity_d, cmap = 'plasma', vmin=0,vmax=0.3)
